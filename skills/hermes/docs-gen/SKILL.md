...
metadata:
  hermes:
    tags: [documentation, docs, api-docs, runbook, changelog, readme, openapi]
    related_skills: [architecture-spec, release-deploy, codebase-onboarding]
---
...
- `web_search` for documentation best practices
